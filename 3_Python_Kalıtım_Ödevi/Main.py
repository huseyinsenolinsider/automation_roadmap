...
web = WebPush("web", True, 123, 123, 123, "tr",
              "web")
trigger = TriggerPush("web", True, 123, 123, 123, "tr",
                      "trigger", "cart")
bulk = BulkPush("web", True, 123, 123, 123, "tr",
                "bulk", 123123)
segment = SegmentPush("web", False, 123, 123, 123, "tr",
                      "bulk", "segmentt")
price_alert = PriceAlertPush("web", True, 123, 123, 123,
                             "tr", "price_alert", 50, 10.0)
in_stock = InStockPush("web", True, 123, 123, 123, "tr",
                       "in_stock", False)
